...
## Each folder functions:

### Components:

The componnets folder holds the page hooks and functions like events and async/await functions of the associated webpage.

### Assets folder:

The assets folder holds the images used.

### Pages folder:

The pages folder holds the webpages structure

### elements folder:

It holds all of the components design like, "navbar" and "buttons"